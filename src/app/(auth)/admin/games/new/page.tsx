...
export default function NewGamePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    about: [''],
    review: '',
    downloads: [] as Array<{title: string, description: string, downloadUrl: string, buttonColor: string}>,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post('/api/games', dataToSend, {
        headers: { 
          Authorization: `Bearer ${token}`,
      ...
      showError(error.response?.data?.message || 'Failed to create game');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <DefaultLayout
      title="Add New Game"
      subtitle="Create a new game entry"
