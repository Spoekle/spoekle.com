        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              <FaCamera className="text-6xl text-neutral-400 mx-auto mb-4" />
              <p className="text-2xl text-neutral-600 dark:text-neutral-400">No photos yet.</p>
              <p className="text-neutral-500 dark:text-neutral-500 mt-2">Check back later for new photos!</p>
            </div>
          ) : (
            ...
            {photos.map((photo, index) => (
              <motion.div
                ...
                className="relative w-full sm:w-[calc(50%-0.5rem)] lg:w-[calc(33.333%-0.667rem)] xl:w-[calc(25%-0.75rem)] aspect-square cursor-pointer overflow-hidden rounded-xl group"
              >
                <Image
        ...
        {selectedPhoto && (
          ...
          >
            ...
            <button
              ...
              className="absolute left-4 text-white hover:text-neutral-300 p-2 z-50"
            >
            ...
            <button
              ...
              className="absolute right-4 text-white hover:text-neutral-300 p-2 z-50"
            >
            ...
            <div className="max-w-7xl w-full flex flex-col lg:flex-row gap-6" onClick={(e) => e.stopPropagation()}>
              ...
              <motion.div
                ...
                className="lg:w-80 bg-neutral-900/90 backdrop-blur-xl rounded-xl p-6 overflow-y-auto"
              >
                <button
                  onClick={closeLightbox}
                  className="absolute top-4 right-4 text-white hover:text-neutral-300 p-2 z-50 hover:cursor-pointer"
                >
