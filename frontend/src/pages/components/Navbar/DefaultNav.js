                ...
                <div className="flex items-center space-x-3">
                    ...
                    {user ? (
                        <div className="relative" >
                            ...
                            {isDropdownOpen && (
                                <div className="absolute right-0 mt-2 w-48 bg-white/70 dark:bg-neutral-900/70 border-neutral-200 dark:border-neutral-800 backdrop-blur-sm border rounded-md shadow-lg py-2">
                                    <div className="flex items-center justify-between">
                                        <NavLink
                                            to="/profile"
                                            className="flex w-full px-4 py-2 text-sm items-center text-neutral-900 dark:text-white hover:bg-black/20"
                                            onClick={toggleDropdown}
                                        >
                                            <img
                                                src={user.profilePicture}
                                    ...
                                    >
                                        Logout <MdLogout size={16} className='ml-1' />
                                    </button>
                                </div>
                            )}
                        </div>
