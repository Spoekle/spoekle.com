// filepath: /data/compose/spoekle.com/frontend/src/pages/Blog/BlogEditor.tsx
...
// Import background image for consistency with blog page
...
const BlogEditor: React.FC = () => {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const response = await fetch('/api/storage/blog-image', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
      ...
      const data = await response.json();
      setPost(prev => ({ ...prev, featuredImage: data.imageUrl }));
  ...
  const savePost = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/blog${isEditing && post.id ? `/${post.id}` : ''}`, {
  ...
  return (
    <DefaultLayout
      ...
      metaDescription="Create or edit a blog post on Spoekle's blog"
    >
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-white dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
              </div>
                ...
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  <div className="flex-1 min-w-[200px]">
                    <input
                      ...
                      className="w-full px-3 py-1.5 bg-white dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    />
                  </div>
                </div>
              </div>
