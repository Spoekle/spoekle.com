...
// Import header image
import headerImage from '../../assets/spoekleMe.webp';
...
const AboutPage: React.FC = () => {
    ...
    return (
        <DefaultLayout
            ...
            metaDescription="Learn more about Spoekle - a developer, content creator, and gaming enthusiast passionate about web development and gaming."
        >
            {/* Bio Section */}
            <section className="py-16 bg-neutral-100 dark:bg-neutral-900/50 rounded-xl overflow-hidden shadow-lg mb-12">
                <div className="container mx-auto px-4 md:px-8">
                    ...
                    >
                        ...
                        <motion.div className="prose prose-lg dark:prose-invert" variants={fadeIn}>
